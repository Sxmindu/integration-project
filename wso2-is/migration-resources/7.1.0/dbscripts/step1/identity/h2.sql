...
SELECT ID, NAME, DESCRIPTION FROM (
	SELECT
		'3e5b1f91-72d8-4fbc-94d1-1b9a4f8c3b07' AS ID,
		'IMPERSONATION_CONFIGURATION' AS NAME,
		'A resource type to keep the tenant impersonation preferences.' AS DESCRIPTION
) temp
