...
ALTER TABLE IDP_AUTHENTICATOR ADD DEFINED_BY VARCHAR(25) DEFAULT 'SYSTEM' NOT NULL
/
ALTER TABLE IDP_AUTHENTICATOR ADD AUTHENTICATION_TYPE VARCHAR(25) DEFAULT 'IDENTIFICATION' NOT NULL
/
ALTER TABLE IDP_AUTHENTICATOR ADD IMAGE_URL VARCHAR(1024)
/
ALTER TABLE IDP_AUTHENTICATOR ADD DESCRIPTION VARCHAR(1024)
/
ALTER TABLE SP_APP ADD VERSION VARCHAR(255) DEFAULT 'v1.0.0' NOT NULL
/
...
ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD TOKEN_BINDING_REF VARCHAR2(32) DEFAULT 'NONE'
/
ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD CONSENTED_TOKEN VARCHAR(6)
/
ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD AUTHORIZED_ORGANIZATION varchar(36) DEFAULT('NONE') NOT NULL
/
-- --------------------------- INDEX CREATION -----------------------------
